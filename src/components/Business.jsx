    ...
    <section id="about" className={layout.section}>
      <div className={layout.sectionInfo}>
        <h2 className={styles.heading2}>
          Share your obstacles, <br className="sm:block hidden" />
          we’ll find the solution.
        </h2>
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          We have run businesses and lead amazing teams. We will give you practical solutions backed by our very own experiences.
        </p>
        {/* <Button styles="mt-10" /> */}
      </div>
